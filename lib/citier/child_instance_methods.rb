    ...
    def save(options={})
      ...
      self.run_callbacks(:save) do
        self.run_callbacks(self.new_record? ? :create : :update) do
          ...
          changed_attributes_for_current = changed_attributes.reject { |key,value| self.class.superclass.column_names.include?(key) || !self.class::Writable.column_names.include?(key) }
